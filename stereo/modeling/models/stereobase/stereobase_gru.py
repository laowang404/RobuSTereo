...
class StereoBase(nn.Module):
    ...
    def forward(self, data):
        ...
        # img_list = [
        #     "/data1/wangyuran/DiffStereo/DiffStereo/OpenStereo/tools/DVT/img_0.png",
        #     "/data1/wangyuran/DiffStereo/DiffStereo/OpenStereo/tools/DVT/img_1.png",
        #     "/data1/wangyuran/DiffStereo/DiffStereo/OpenStereo/tools/DVT/img_2.png",
        #     "/data1/wangyuran/DiffStereo/DiffStereo/OpenStereo/tools/DVT/img_3.png",
        # ]
        ...
        #     img_tensor.append((2 * torch.from_numpy(img).float().permute(2, 0, 1) / 255.0 - 1.0).contiguous())

        # img_tensor = torch.stack(img_tensor, 0).cuda()
