...
class cfnet(nn.Module):
    ...
    def forward(self, data):
        ...
        if self.training:
            ...
            return {'train_preds': [pred0_4, pred1_4, pred2_s4, pred0_s3, predmid_s3, pred1_s3_up, pred0_s2, predmid_s2, pred1_s2],
                'disp_pred': pred1_s2}
        else:
            pred2_s4 = F.upsample(pred2_s4 * 8, [left.size()[2], left.size()[3]], mode='bilinear', align_corners=True)
            pred2_s4 = torch.squeeze(pred2_s4, 1)
    ...
    def get_loss(self, model_pred, input_data):
        ...
        model_pred = model_pred["train_preds"]
        loss = 0.
        for disp_est, weight in zip(model_pred, weights):
            loss += weight * F.smooth_l1_loss(disp_est[mask], disp_gt[mask], reduction='mean')
