...
from .datasets.diw_dataset import DIWDataset as _DIWDataset
from .datasets.mapillary_dataset import MapillaryDataset
import yaml


class DIWDataset(DatasetTemplate):
    def __init__(self, data_info, data_cfg, mode):
        ...
        self.dataset = _DIWDataset(self.root,
    ...
    def __getitem__(self, idx):
        ...
        # print("DIW_shape", sample['left'].shape, sample['left'].dtype)
        return sample
