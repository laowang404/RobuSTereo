...
class DiffStereoDataset(DatasetTemplate):
    ...
    def __getitem__(self, idx):
        ...
        left_img = cv2.resize(left_img, (disp_shape[1], disp_shape[0]))
        right_img = cv2.resize(right_img, (disp_shape[1], disp_shape[0]))
        # print(left_img.shape, right_img.shape, disp_img.shape)
